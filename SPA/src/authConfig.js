...
export const msalConfig = {
  auth: {
    clientId: '87db90c6-97b4-41dc-82b2-7cda69da58b3', // This is the ONLY mandatory field that you need to supply.
    authority:
      'https://login.microsoftonline.com/b8ff19b6-78c3-4706-97a1-a2712549d8d5', // Defaults to "https://login.microsoftonline.com/common"
...
export const protectedResources = {
  apiTodoList: {
    ...
    scopes: [
      'api://87db90c6-97b4-41dc-82b2-7cda69da58b3/access_via_group_assignments',
    ],
  },
  apiGraph: {
...
export const groups = {
  groupAdmin: 'f96fbbdf-17a4-4b8c-ae92-69fd2ce2758f',
  groupMember: '82815d9e-df9a-4f1d-99d7-d62bdf599d86',
};
